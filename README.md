...
1. Clone the repository:
   ```bash
   git clone https://github.com/GlobalWorkspaceHoldings/newtab.git
   cd newtab
   ```

2. Open `index.html` in your web browser to view the landing page

3. Customize templates in `template.html` as needed

## Usage

You can deploy this landing page to use as your custom new tab page by:

1. Installing a browser extension that allows custom new tab pages (e.g., custom new tab extensions)
2. Uploading or hosting the HTML files
3. Configuring your browser to use the custom landing page
...
2. Modify styles and layout in the `<style>` sections
3. Update content and links as needed for your organization
